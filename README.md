<!-- =============================================== -->
<!--   ELITE CYBER AESTHETIC GITHUB PROFILE README  -->
<!-- =============================================== -->

<p align="center">
  <img
 src="https://capsule-render.vercel.app/api?type=waving&color=0:FADADD,25:E0C3FC,50:B8D8FF,75:C2F0FC,100:00E5FF&height=320&section=header&text=Vardaan%20Saxena&fontSize=68&fontColor=ffffff&animation=fadeIn&fontAlignY=38"/>
</p>
...
Name: Vardaan Saxena
Location: India 🇮🇳
Role: Full Stack Engineer | AI Explorer | System Architect
Experience: 3+ Years of Product Engineering
Core Stack: Next.js • Node.js • Python • TypeScript • Docker • AWS
Specialization: Scalable Systems • AI/ML • Cloud • Automation • System Design
Mindset: Build → Break → Optimize → Scale → Repeat
Mission: Engineering high-impact products that solve real-world problems at scale.
```

# 🛠️ Tech Stack

> Tools, languages, and technologies I use to build fast, scalable, and secure applications.
...
![Nmap](https://img.shields.io/badge/Nmap-000000?style=for-the-badge&logo=gnometerminal)
...
<p align="center">
  ...
  <a href="https://leetcode.com/u/jvJTEFciK8/">
    <img src="https://img.shields.io/badge/LeetCode-Solve-FFA116?style=for-the-badge&logo=leetcode&logoColor=black">
  </a>
  <a href="https://codeforces.com/profile/vardaan09">
    <img src="https://img.shields.io/badge/Codeforces-Compete-1F8ACB?style=for-the-badge">
  </a>
  <a href="https://www.codechef.com/users/srvkiller09">
    <img src="https://img.shields.io/badge/CodeChef-Practice-5B4638?style=for-the-badge">
  </a>
</p>
